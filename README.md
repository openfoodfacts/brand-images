...
| Folder | Description |
|--------|-------------|
| `xx/agencies` | Logos of agencies (e.g. `ANSES`) |
| `xx/brands` | Logos of brands (e.g. `Coca-Cola`) |
| `xx/stores` | Logos of stores (e.g. `Carrefour`) |
...
|--------|----------------:|----:|----:|
| `xx/agencies` | 5 (5) | 5 | 0 |
| `xx/brands` | 5190 (5069) | 873 | 263 |
| `xx/stores` | 2216 (2164) | 915 | 1296 |
